...
const Quality = () => {
  return (
    <>
      <div className="qualtiy_main d-flex justify-content-center">
        <div className="qualtiy_wrapper d-flex justify-content-around">
          <div className="quality_div">
            <div className="qualtity_img_div text-center">
