    ...
    <>
      <div className='single_product_wrapper universal_container'>
        <div className='single_product_left'>
          <div onMouseMove={((e)=>mouseEnterZoom(e))} onMouseLeave={(()=>mouseLeaveZoom())} className='single_product_img_div'>
            <img style={{width:'100%',height:'100%',objectFit:'cover',transformOrigin:`${position.x}px ${position.y}px`,transform:`scale(${position.scale})`,overflow:'hidden'}} src={imgUrl}/>
          </div>
          <div className='single_product_small_images_wrapper'>
          {[img,img2,img3,img].map((e,i)=>{
            return(
                <>
                <div onClick={(()=>setimgUrl(e))} className='single_product_small_img'>
                    <img  src={e}/>
                </div>
                </>
            )
        ...
        <div className='single_product_right'>
            ...
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
            <div className='single_product_rates'>
                4.8 (245) Reviews
            </div>
            </div>
           ...
           <div className='lorem_text_div' style={{
            width:"81%"
           }}>
           <p className='lorem_text'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
           </div>
           ...
           <div>
            <p className='delivery_para'>Delivery by 15 May, Thursday | <span>Free</span> ₹40</p>
           ...
           <div className='count_plus' onClick={(()=>{
               setCount(count + 1)
           })} > + </div>
            <div className='count_div'>{count}</div>
            <div className='count_minus' onClick={(()=>{
            if(count <= 0){
              setCount(0)
            }else{
              setCount(count - 1)
           ...
           <button className='buy_now_btn' onClick={()=>navigate('/cart')}>Buy Now</button>
           <button className='add_to_cart_btn' onClick={()=>navigate('/cart')}>Add To Cart</button>
