  ...
  return (
    <>
      ...
      <div className='sidebar_header'>
        <i class="fa-solid fa-xmark" onClick={(()=>setSidebarOpen(false))}></i>
      </div>
      <div className='sidebar_link_div'>
        <div onClick={(()=>{
            setDropdown(!dropdown)
        })} className='sidebar_link'>Women 
      <i class="fa-solid fa-caret-down"></i>
      </div>
    { dropdown && <div className='sidebar_dropdown'>
            <p>Saree <i class="fa-solid fa-caret-down"></i></p>
            <p>Kurti</p>
            <p>Lorem</p>
            <p>Ipsum</p>
        </div>}
