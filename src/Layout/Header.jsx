...
const Header = () => {
  ...
  return (
    <>
{ sidebarIsOpen   && <Sidebar sidebarIsOpen={sidebarIsOpen} setSidebarOpen={setSidebarOpen}/>}
      <marquee speed='0.3' className='header_top'> Use Code: FIRSTBUY5 – Get 5% OFF on your first purchase | Enjoy FREE Shipping across India. Shop now and save big! | Enjoy FREE Shipping across India. Shop now and save big! | Enjoy FREE Shipping across India. Shop now and save big! | Enjoy FREE Shipping across India. Shop now and save big! | Enjoy FREE Shipping across India. Shop now and save big!</marquee>
       {/* Navbar Starts From Here */}

       <nav className='nav_wrapper_main'>
        <div className='nav_cover_div'>
           <i onClick={(()=>setSidebarOpen(!sidebarIsOpen))} class="fa-solid fa-bars-staggered"></i>
            ...
            <div className='nav_link_div'>
               ...
               <div className='dropdown_div_nav women_dropdown'>
                  <div className='dropdown_item'  onMouseEnter={(()=>setToggle({saree:true}))}>Saree <img  src={right}/></div>
               ...
               {toggle.saree &&  <div className='nested_drowdown_div' onMouseLeave={(()=>setToggle({saree:false}))} >
            ...
            <i onClick={() => navigate('/register')} class="fa-regular fa-user"></i>
        ...
        <i onClick={(()=>setSearch(!search))} class="fa-solid fa-magnifying-glass"></i>
        <i onClick={(()=>setSearch(!search))} class="fa-solid fa-x" style={{
            position:'absolute',
            top:'15px',
            right:'0px',
            fontSize:'20px',
