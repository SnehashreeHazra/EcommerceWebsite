                ...
                <div class="row">
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta" style={{
                            ...
                            <div class="cta-text">
                                <h4>Find us</h4>
                                <span>12B, Outer Circle Road, 7 Green Valley Heights, WB, 713105</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-md-4 mb-30">
                    ...
                    <div class="col-xl-4 col-md-4 mb-30">
                        <div class="single-cta">
                            ...
                            <div class="cta-text">
                                <h4>Mail us</h4>
                                <span>hello@arbeeboutique.com</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 text-center text-lg-left">
                        <div class="copyright-text">
                            <p>Copyright &copy; 2024 Sooti. Powered by Snehashree Hazra.</p>
                        </div>
                    </div>
